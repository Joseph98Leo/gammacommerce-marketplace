    ...
    <footer className="bg-card border-t border-border">
      <div className="container mx-auto px-4 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="md:col-span-2">
            ...
            <p className="text-muted-foreground mb-4 max-w-md">
              Tu destino de compras online. Descubre productos extraordinarios de las mejores marcas con la mejor experiencia de compra.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li className="flex items-center gap-2 text-muted-foreground">
                ...
                <span>info@gammacomerce.com</span>
              </li>
              <li className="flex items-center gap-2 text-muted-foreground">
        ...
        <div className="border-t border-border mt-8 pt-8 text-center text-muted-foreground text-sm">
          <p>© 2024 GammaComerce. Todos los derechos reservados.</p>
        </div>
      </div>
    </footer>
  );
